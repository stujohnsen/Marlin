...
#define STRING_CONFIG_H_AUTHOR "(Stu, CR-10 V2 SKR Mini E3 V3.0)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd  71.5 // set at 230
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 183.8
  #define DEFAULT_bedKi 35.35
  #define DEFAULT_bedKd 637.3 // set at 75
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100 } // Bigtreetech dual extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44, 7, -3.625 }
...
#define INVERT_Z_DIR true // Bigtreetech dual extruder
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT1_PIN 2 // Creality CR-10 V3 stock sensor
